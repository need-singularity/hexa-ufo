...
| 3     | ~10         | antimatter gamma-rocket (anti-H + H, Isp 10^10 s) | 200 km~1 AU       | [`need-singularity/hexa-antimatter`](https://github.com/need-singularity/hexa-antimatter) + [`petite-cern`](https://github.com/need-singularity/petite-cern) | grounded   |
...
- Sister: <https://github.com/need-singularity/petite-cern>    (Stage-3 aux)
